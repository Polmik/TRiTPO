...
Панель с вкладками должна содержать следующие вкладки:
...
Вкладка PhoneBook должна иметь:
...
2. Удобство и простота использования. Интерфейс должен быть интуитивно понятен и не вызывать трудностей при работе с ним. Каждая кнопка переключения вкладок должна выводить информационное сообщение при наведении на нее курсора мыши.  
...
Загрузка и отображение основного окна программы не должны превышать 2 секунд.
